# AutomatosX v3.1.1 - AI Agent Orchestration Platform
...
AutomatosX v3.1.1 supports dynamic role creation and removal, allowing you to extend the AI team with custom agents
